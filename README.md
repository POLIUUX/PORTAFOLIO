...
My journey in IT support led me to develop a passion for cybersecurity, and I am now eager to transition into this field, specifically aiming to join a Security Operations Center (SOC) as a Tier 1 Analyst.

## Skills
- Core Cybersecurity Skills
Basic understanding of cybersecurity concepts 
Knowledge of threats like phishing, malware, social engineering
Awareness of security best practices
- Technical / IT Skills
Operating systems: Windows + some Linux exposure
Hardware & troubleshooting (from CompTIA A+)
Basic understanding of:
Networking concepts
System performance issues
Device troubleshooting
- SOC / Blue Team Skills (early level)
Basic incident response thinking 
Understanding of:
Phishing detection
Security alerts
User/device compromise situations
Exposure to log analysis concepts
- Analytical Skills
Problem-solving 
Ability to follow investigation steps
Beginning mindset of a security analyst 
- Learning & Professional Skills
Self-learning through certifications
